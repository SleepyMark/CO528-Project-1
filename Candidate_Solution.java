...
public class Candidate_Solution
{
    ...
    public void mutate()
    {
        ...
        if(fitnessValue > prevFitness) dials[prevIndex] = prevDial;
        ...
        if(Math.abs(dials[index]) > 5) dials[index] = (Math.random() * 10) -5;
    ...
    public Candidate_Solution crossOver(Candidate_Solution b)
    {
        ...
        for(int dial=0; dial<20; dial++){
            if(dial%2==0) newSolution.setDial(dial, this.dials[dial]);
