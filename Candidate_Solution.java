...
public class Candidate_Solution
{
    ...
    public void setFitness(double fit)
    {
        ...
        if(fitnessValue < 20)mutationFactor = 4;
        if(fitnessValue < 15)mutationFactor = 2;
        if(fitnessValue < 10)mutationFactor = 1;
        /*if(fitnessValue < 5)mutationFactor = 0.9;
        if(fitnessValue < 4)mutationFactor = 0.8;
        if(fitnessValue < 3)mutationFactor = 0.7;
        if(fitnessValue < 2)mutationFactor = 0.6;
        if(fitnessValue < 1)mutationFactor = 0.5;*/
